...
local constants = {
    ...
    openLiftModuleFileName = 'station/rail/openLifts/openLift.module',
    openLift_NoAutoLink_ModuleFileName = 'station/rail/openLifts/openLift_NoAutoLink_v2.module',
    openStairsUpLeftModuleFileName = 'station/rail/openStairs/openStairsUpLeft.module',
    openStairsUpLeft_NoAutoLink_ModuleFileName = 'station/rail/openStairs/openStairsUpLeft_NoAutoLink.module',
    openStairsUpRightModuleFileName = 'station/rail/openStairs/openStairsUpRight.module',
    openStairsUpRight_NoAutoLink_ModuleFileName = 'station/rail/openStairs/openStairsUpRight_NoAutoLink.module',
    restorePassengerTerminalModuleFileName = 'station/rail/restorePassengerTerminal.module',
    passengerTerminalModuleFileName = 'station/rail/passengerTerminal.module',
    trackSpeedSlowModuleFileName = 'station/rail/trackSpeedSlow.module',
    trackSpeedFastModuleFileName = 'station/rail/trackSpeedFast.module',
    trackSpeedUndefinedModuleFileName = 'station/rail/trackSpeedUndefined.module',
    trackElectrificationNoModuleFileName = 'station/rail/trackElectrificationNo.module',
    trackElectrificationYesModuleFileName = 'station/rail/trackElectrificationYes.module',
    trackElectrificationUndefinedModuleFileName = 'station/rail/trackElectrificationUndefined.module',
